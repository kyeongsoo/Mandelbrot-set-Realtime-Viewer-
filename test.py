...
class Fractal:
    def __init__(self, app):
        ...
        # taichi architecture, you can use ti.cpu, ti.gpu, ti.cuda, ti.opengl, ti.vulkan, ti.metal
        ti.init(arch=ti.gpu)
        # taichi fields
    ...
    def draw_rectangle(self):
        if self.mouse_lb_pressed:
            pg.draw.rect(self.screen, pg.Color('white'),
                         (self.pos_old[0],
                          self.pos_old[1],
                          self.pos_new[0]-self.pos_old[0],
                          self.pos_new[1]-self.pos_old[1]),
                         width=1,
                         border_radius=0)
